...
def process_video(filepath):
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            angles["wrist"].append(calculate_angle(left_elbow, left_wrist, [landmarks[mp_pose.PoseLandmark.LEFT_INDEX.value].x, landmarks[mp_pose.PoseLandmark.LEFT_INDEX.value].y]))
