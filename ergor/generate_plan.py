...
def generate_plan(user_id, employee_id, method):
    ...
    if method == "ROSA":
        ...
        prompt = (
            ...
            f"2. **Plan de mejora ergonómico personalizado:** Proporciona recomendaciones claras y prácticas para abordar los riesgos identificados con el método OWAS en el ámbito de carga. Asegúrate de incluir soluciones específicas, como prácticas preventivas y sugerencias de capacitación ergonómica.\n"
            f"3. **Justificación del plan:** Explica brevemente por qué las soluciones propuestas son efectivas para mitigar los riesgos y cómo contribuyen al bienestar del empleado con el método OWAS en el ámbito de carga.\n\n"
            f"**Notas adicionales:**\n"
            f"- El diagnóstico debe ser lo más detallado posible, priorizando las áreas con mayor puntaje.\n"
            f"- Las recomendaciones deben ser prácticas, priorizando aquellas de fácil implementación pero con alto impacto.\n"
            f"- Considera el perfil físico del empleado y el contexto laboral para personalizar las soluciones."
